...
class MyWindow:
    ...
    def __init__(self, win):
        ...
        self.Button1 = Checkbutton(self.mywindow, text = "Ottoman", 
        ...
        self.Button2 = Checkbutton(self.mywindow, text = "Russian",
    ...
    def ocr_with_tesseract(self):
        ...
        if (self.Checkbutton1.get()== 0) and (self.Checkbutton2.get() ==0):
            ...
            finished_flag, dst = perform_ocr(self.filename, self.dst_dir ,'ara+fas')

        else:
            finished_flag, dst = perform_ocr(self.filename, self.dst_dir, 'rus')
